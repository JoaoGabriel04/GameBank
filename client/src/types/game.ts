...
export interface RankedPlayer {
  position: number
  player: { id: number; nome: string; cor?: string; userId?: number | null; desistiu?: boolean; avatarUrl?: string | null; avatarUpdatedAt?: string | null; banner?: string | null; bannerAnimated?: boolean; badge?: string | null; badgeImageUrl?: string | null }
  patrimony: number
  xpEarned: number
  coinsEarned: number
