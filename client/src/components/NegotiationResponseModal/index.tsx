        ...
        <div className="space-y-4">
          ...
          {targetPlayer && (
            <div className="relative overflow-hidden rounded-xl border border-zinc-700">
              <UserBanner banner={targetPlayer.banner} animated={targetPlayer.bannerAnimated} className="absolute inset-0 w-full h-full" />
        ...
        <div className="space-y-4">
          ...
          {!isCountering ? (
            <>
              {fromPlayer && (
                <div className="relative overflow-hidden rounded-xl border border-zinc-700">
                  <UserBanner banner={fromPlayer.banner} animated={fromPlayer.bannerAnimated} className="absolute inset-0 w-full h-full" />
                  <div className="absolute inset-0" style={{ background: "linear-gradient(0deg,rgba(9,9,11,.85) 0%,transparent 60%)" }} />
                  <div className="relative z-10 flex items-center gap-3 p-3">
                    <UserAvatar
