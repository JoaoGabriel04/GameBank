'use client';
/**
 * Cofre — Inventário de cosméticos do jogador
 * Salve em: src/app/user/(main)/cofre/page.tsx
 *
 * Nova aba substituindo Salas no menu de navegação.
 * Layout: sidebar de categorias | grid de itens | painel de detalhes
 * Equipar/desequipar via equipShopItemApi.
 */
          ...
          {rMeta && (
            ...
            >
              <span
                ...
                style={{ width: 5, height: 5, background: rMeta.color }}
              />
              {rMeta.label}
            </span>
          )}
